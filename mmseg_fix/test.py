...
def single_gpu_test(model,
                    ...
                    show=False,
                    out_dir=None,
                    efficient_test=False, # Modified
                    inference=False): # Modified
    ...
    Args:
        ...
        inference (bool): Whether this is an inference task or not, which starts # Modified
            after train & validation process is finished. Default: False. # Modified
