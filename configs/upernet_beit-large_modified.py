_base_ = [
    '/opt/ml/input/code/mmsegmentation/configs/_base_/models/upernet_beit.py',
    '/opt/ml/input/code/mmsegmentation/configs/_base_/datasets/ade20k_to_coco.py',
    '/opt/ml/input/code/mmsegmentation/configs/_base_/default_runtime.py',
