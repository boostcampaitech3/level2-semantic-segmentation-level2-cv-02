...
from mmcv.runner import get_dist_info, init_dist, _load_checkpoint
...
def main():
    ...
    checkpoint = _load_checkpoint(cfg.model.pretrained, logger=logger, map_location='cpu')
    state_dict = checkpoint['state_dict']
    state_dict = put_checkpoint(model, state_dict, cfg)
